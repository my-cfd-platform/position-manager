...
use crate::{AppContext, EngineBidAsk, EngineError, EnginePosition, ExecutionClosePositionReason, ExecutionPositionBase};
...
pub async fn close_position(
    ...
    let Some(removed_position) = active_cache.remove_position(
    ...
    let closed_position =
        removed_position.close_position(process_id, close_position_reason);
